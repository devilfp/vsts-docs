...
| **Auditing** | `vso.auditlog` | Audit (read) | Grants the ability to read audit log events. |
| | `vso.auditlog_manage` | Audit Streams (manage) |  Grants the ability to manage audit streams. |
| | `vso.auditlog_delete` | Audit Streams (delete) |  Grants the ability to delete audit streams. |
