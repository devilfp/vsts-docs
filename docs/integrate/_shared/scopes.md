...
| **Auditing** | `vso.auditlog` | Audit (read) | Grants the ability to read audit log events and streams. |
| | `vso.auditlog_manage` | Build (read and execute) |  Grants the ability to manage audit log events and streams. |
| | `vso.auditlog_delete` | Build (read and execute) |  Grants the ability to delete audit log events and streams. |
